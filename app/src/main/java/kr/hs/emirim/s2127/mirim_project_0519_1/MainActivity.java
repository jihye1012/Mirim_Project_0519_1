package kr.hs.emirim.s2127.mirim_project_0519_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRed.setOnClickListener(btnListenr);
        btnYellow.setOnClickListener(btnListenr);
        btnBlue.setOnClickListener(btnListenr);
    }
